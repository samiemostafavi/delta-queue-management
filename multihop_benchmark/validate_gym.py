...
def parse_validate_gym_args(argv: list[str]):
    ...
    try:
        opts, args = getopt.getopt(
            argv,
            "hq:d:w:l:r:c:y:",
            ["qlens=", "ldps=", "dataset=", "label=", "rows=", "columns=", "y-points="],
        )
...
def run_validate_gym_processes(exp_args: list):
    logger.info(
    ...
    # figure
    fig.tight_layout()
    fig.savefig(project_path + "gym_validation_bulk.png")
